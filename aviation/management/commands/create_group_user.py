...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        change_aircraft_permission = Permission.objects.get(content_type__app_label='aviation', codename='change_aircraft')
        delete_aircraft_permission = Permission.objects.get(content_type__app_label='aviation', codename='delete_aircraft')
        view_aircraft_permission = Permission.objects.get(content_type__app_label='aviation', codename='view_aircraft')

        group_flight_manager.permissions.add(add_flight_permission, change_flight_permission, delete_flight_permission, view_flight_permission, add_aircraft_permission, change_aircraft_permission, delete_aircraft_permission, view_aircraft_permission)

        user_flight_manager.groups.add(group_flight_manager)
        user_flight_manager.is_staff = True
        user_flight_manager.save()
        self.stdout.write(self.style.SUCCESS(f"User '{user_flight_manager.username}' added to group 'FlightManager' with permissions!"))
        ...
        change_passenger_permission = Permission.objects.get(content_type__app_label='aviation', codename='change_passenger')
        delete_passenger_permission = Permission.objects.get(content_type__app_label='aviation', codename='delete_passenger')
        view_passenger_permission = Permission.objects.get(content_type__app_label='aviation', codename='view_passenger')
        ...
        change_booking_permission = Permission.objects.get(content_type__app_label='aviation', codename='change_booking')
        delete_booking_permission = Permission.objects.get(content_type__app_label='aviation', codename='delete_booking')
        ...
        group_ticketing_staff.permissions.add(
            add_passenger_permission, change_passenger_permission, delete_passenger_permission, view_passenger_permission,
            add_booking_permission, change_booking_permission, delete_booking_permission, view_booking_permission
        )
        ...
        self.stdout.write(self.style.SUCCESS(f"User '{user_ticketing_staff.username}' added to group 'Ticketing Staff' with permissions!"))
